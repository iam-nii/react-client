  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <h1 className="font-medium text-center mb-5 text-3xl">Регистрация</h1>
        <div className="mb-6">
        ...
        <div className="mb-6">
          <Autocomplete
            ...
            fullWidth
            renderInput={(params) => (
              <TextField {...params} label="Роль" inputRef={roleRef} />
            )}
            name="role"
          />
        </div>
        ...
        <div className="mt-5">
          ...
          >
            <Link to="/signin">
              <span className="font-light mr-1">Вход в систему</span>
            </Link>
          </Typography>
        </div>
      </form>
